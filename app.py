...
def set_png_as_page_bg(png_file):
    ...
    <style>
    .stApp {
    background-image: url("data:http://cdn.itdaily.kr/news/photo/202103/202318_202307_3426.jpg;base64,%s");
...
upload_file = st.side.file_uploader("토마토 잎을 올려주세요", type=["jpg","jpeg","png","webP"])
